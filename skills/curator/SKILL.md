...
name: curator
description: >
  Obsidian Vault Wiki 策展人。掃描 主題知識/ 下所有筆記，執行健康檢查（孤兒頁面、
  缺失交叉引用、過期條目、未解決矛盾、缺漏的概念頁、index.md 一致性）與結構演進
  （偵測並執行主題頁面升級為目錄結構），輸出修補建議報告。
  觸發情境：使用者說「lint」、「檢查 wiki」、「wiki 健康度」、「wiki 體檢」、
  「看看 wiki 有什麼問題」、「整理 wiki」、「wiki 結構檢查」、「升級主題」時使用。
...
- **結構演進**（新增）：偵測符合升級條件的主題頁面，報告後由使用者確認執行升級（單頁 → 目錄結構）
- **自動修補**：偵測後報告，使用者確認才執行
