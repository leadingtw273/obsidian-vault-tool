...
allowed-tools: ["Read", "Write", "Edit", "Glob", "Grep", "Bash(${CLAUDE_PLUGIN_ROOT}/scripts/check-deps.sh:*)", "Bash(${CLAUDE_PLUGIN_ROOT}/scripts/check-init-status.sh:*)", "Bash(${CLAUDE_PLUGIN_ROOT}/skills/wsl-powershell-bridge/scripts/powershell.sh:*)"]
---
